...
function showFooter() {
  return `<div class="container-fluid footer">
              ...
              <div class="col-12 text-center footer-content">
                <div class="footer-title text-white">
                  ...
                  <ul class="list-unstyled text-uppercase">
                    ...
                    <li class="mb-3">Kota Denpasar, Bali </li>
                  </ul>
            ...
            <div class="text-footer text-white text-center">
              <p class="m-0">
                Created with <i class="fa-solid fa-heart text-danger"></i> by <p style= "color:yellow">Amrita Raj  </P> © 2022 Copyright | All Rights Reserved
              </p>
            </div>
          </div>`;
}
